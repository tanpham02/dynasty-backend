...
var ProductVariantService = /** @class */ (function (_super) {
    ...
    function ProductVariantService(model, nameService) {
        return _super.call(this, model, nameService) || this;
    }
    // GET BY ID
    ProductVariantService.prototype.getByIdOverridingHavePopulate = function (id, populateName) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 8, , 9]);
                        category = void 0;
                        if (!populateName) return [3 /*break*/, 5];
                        if (!Array.isArray(populateName)) return [3 /*break*/, 2];
                    ...
                    case 1:
                        category = _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.model.findById(id).populate(populateName)];
                    case 3:
                        category = _a.sent();
                        _a.label = 4;
                    case 4: return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.model.findById(id)];
                    case 6:
                        category = _a.sent();
                        _a.label = 7;
                    case 7: return [2 /*return*/, category];
                    case 8:
                        error_1 = _a.sent();
                        console.log(error_1);
                        throw new Error("Occur error when find by id ".concat(this.nameService, " with ").concat(error_1));
                    case 9: return [2 /*return*/];
                }
            });
        });
    };
    ProductVariantService.prototype.createOverriding = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var newProductVariant, listProductId, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        newProductVariant = new this.model(req.body);
                        listProductId = newProductVariant.productIds;
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, newProductVariant.save()];
    ...
    ProductVariantService.prototype.deleteOverriding = function (ids) {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
