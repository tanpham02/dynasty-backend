    ...
    create: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, productService.createOverriding(req)];
                case 1:
                    product = _a.sent();
                    res.status(200).json(product);
                    return [3 /*break*/, 3];
    ...
    update: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, productService.updateOverriding(id, req)];
                case 2:
                    response = _a.sent();
    ...
    getById: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, productService.getByIdOverridingHavePopulate(id, 'productVariantId')];
                case 2:
                    product = _a.sent();
                    if (!product) {
    ...
    delete: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, productService.deleteOverriding(ids)];
                case 2:
