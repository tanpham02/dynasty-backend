...
var comboPromotions_2 = __importDefault(require("@app/services/comboPromotions"));
var comboService = new comboPromotions_2.default(comboPromotions_1.default, 'combo promotions');
    ...
    create: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, comboService.createOverriding(req)];
                case 1:
    ...
    delete: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, comboService.deleteOverriding(ids)];
                case 2:
...
exports.default = comboPromotionsController;
