...
var material_1 = __importDefault(require("@app/models/material"));
var material_2 = __importDefault(require("@app/services/material"));
var materialService = new material_2.default(material_1.default, 'material');
var materialController = {
    // SEARCH PAGINATION
    search: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, pageIndex, pageSize, from, to, params, material, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.query, pageIndex = _a.pageIndex, pageSize = _a.pageSize, from = _a.from, to = _a.to;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    params = {
    ...
    // CREATE MATERIAL
    createMaterial: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var newMaterial, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, materialService.createOverriding(req)];
                case 1:
                    newMaterial = _a.sent();
    ...
    delete: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, materialService.deleteOverriding(id)];
                case 2:
                    _a.sent();
